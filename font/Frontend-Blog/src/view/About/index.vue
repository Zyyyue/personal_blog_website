        ...
        <div class="about-card">
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>你好，我是 <strong>FeiTwnd</strong>，一名喜欢折腾代码的普通计科学生。</p>
              <p>江西理工大学计算机科学与技术 24 级在读，主要兴趣和精力都投在了探索 Web 开发的方方面面。</p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              ...
              <p>如果你仔细看看，会发现这里除了技术分享，还有不少我的日常琐碎和内心所想，记录这些才是我最初建立这里的根本原因。</p>
              <p>我过去没有写日记的习惯，以至于许多重要的时刻和感受，都在时间的流逝中变得模糊不清。这让我觉得有些遗憾。</p>
              <p>于是，我想在这里诚实地留下一些痕迹。记录下解决问题时的思路，也记录下某个黄昏的触动；分享学到的知识，也分享那些不成熟但真实的思考。</p>
              <p>我相信，当未来的某一天回看这些文字，无论是为某个技术难点焦头烂额，还是为生活中一件小事感慨，这些记录都会让那个时刻的我，与现在的我重逢，并会心一笑。</p>
              <p>感谢你的到访。这里没什么特别，只是一个学生记录成长、思考和生活的地方。欢迎常来坐坐。</p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="contact-list">
              ...
              <div class="contact-item">
                ...
                <router-link to="/message" class="contact-link">去留言板看看 →</router-link>
              </div>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>本网站含有 <strong>主页 Home</strong>、<strong>博客 Blog</strong>、<strong>简历 CV</strong>、<strong>管理 Admin</strong> 四个端，采用黑白简约风格。</p>
              <div class="tech-stack">
                <h4 class="tech-label">前端 Vue3</h4>
                <h4 class="tech-label">后端 SpringBoot3</h4>
              </div>
              <p v-if="personalInfo.github" class="github-hint">
                如果你喜欢这样的风格或对部分功能感兴趣，欢迎去
                <a :href="personalInfo.github" target="_blank" rel="noopener" class="inline-link">
                  <svg viewBox="0 0 24 24" width="14" height="14" fill="currentColor" style="vertical-align: -2px; margin-right: 2px">
          ...
          <section class="about-section about-section--last">
            ...
            <p class="copyright-text">
              本博客所有原创文章采用 <strong>CC BY-NC-SA 4.0</strong> 协议进行许可。转载请注明出处，禁止商业使用，演绎作品需以相同方式共享。
            </p>
          </section>
        </div>
      </div>
